...
- [ ] Continue splitting report output caches by section after measuring payload and compute hotspots: next candidates are player static enrichment maps keyed by player-set signature and stable source-trace/admin diagnostics.
