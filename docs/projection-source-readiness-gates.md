...
| Status | Meaning |
| --- | --- |
| `blocked` | Do not call, snapshot, weight, or present this source for production features until package/legal/source evidence changes. |
...
| FantasyPros projections | `blocked` | Blocked | No | Run paced expanded/projection checks after endpoint rights and package access are approved. |
