 ...
 * Currently runs KTC snapshot storage every Tuesday at 11 PM
 */
export function initializeScheduledJobs() {
  // Schedule KTC snapshot every Tuesday at 11 PM (23:00)
  ...
  function checkAndRunKtcSnapshot() {
    ...
    // Check if it's Tuesday (2) and between 23:00 and 23:59
    if (dayOfWeek === 2 && hours === 23 && minutes >= 0 && minutes < 1) {
  ...
  console.log('[Scheduled Jobs] Initialized - KTC snapshots will run every Tuesday at 11 PM');
}
