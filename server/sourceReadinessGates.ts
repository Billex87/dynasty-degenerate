...
export const SOURCE_READINESS_GATES: SourceReadinessGate[] = [
  ...
  },
  {
    ...
    evidence: {
      ...
      authModel: 'FANTASY_NERDS_API_KEY or FANTASYNERDS_API_KEY; June 5, 2026 local shell has neither configured. TEST fallback is development-only and not production evidence.',
      rowCount: 'Blocked until current-season non-TEST rows are confirmed; local stored Fantasy Nerds snapshot history is partial context, not package approval.',
