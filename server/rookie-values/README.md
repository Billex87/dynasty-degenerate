...
- `2026RookieBlendSnapshot.json`: active 2026 rookie baseline. This is the first stabilized May 2026 multi-source blend with Flock Fantasy, Dynasty Nerds, KTC, FantasyCalc, and DynastyProcess coverage.
