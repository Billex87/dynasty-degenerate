    ...
    actionQueue: [
      {
        ...
        risk: 'Risk Low; upside High.',
        confidence: 84,
        tone: 'good',
        blockers: [],
        missingEvidence: [],
        sourceHealth: ['Roster data: 91%', 'Market signal: 84%'],
        receipts: ['Young backup RB behind valuable touches.', 'Bench churn spot is available.'],
      ...
      },
      {
        ...
        changeTriggers: ['If partner demand disappears, do not force the trade.', 'If the return lacks young value or picks, keep this as watch only.'],
    ...
    actionQueue: [
      {
        ...
        risk: 'Risk Medium; role can disappear when injured starters return.',
        confidence: 85,
        tone: 'good',
        blockers: [],
        missingEvidence: [],
        sourceHealth: ['Season value: 86%', 'Usage signal: 72%'],
        receipts: ['Near-term touches beat stash value.', 'Goal-line usage can create immediate scoring windows.'],
        changeTriggers: ['Live ownership or recent transaction changes would block the pickup.', 'If the workload window closes, downgrade this to watch only.'],
      ...
      },
      {
        ...
        risk: 'Risk Low; verify final injury and weather context.',
        confidence: 81,
        tone: 'good',
        blockers: [],
        missingEvidence: [],
        sourceHealth: ['Roster data: 91%', 'Usage signal: 72%'],
        receipts: ['Route participation is cleaner.', 'The lineup needs bankable weekly points.'],
