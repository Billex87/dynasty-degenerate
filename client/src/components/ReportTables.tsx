    ...
    <span className="partner-chip-reverse">
      ...
      <ChampionAvatarFrame managerName={manager}>
        {avatarUrl ? (
          ...
          <span aria-hidden="true" className="partner-chip-fallback">
            {initial}
          </span>
        )}
      </ChampionAvatarFrame>
...
function ManagerMiniLine({
  ...
  if (onClick) {
    return (
      <button
        type="button"
        className="command-mini-line command-mini-button"
        onClick={onClick}
      >
        {content}
      </button>
  ...
  return <div className="command-mini-line">{content}</div>;
}
...
export function OwnerIntelMatrix({
  ...
  const selectedActionNotes = selectedRow
    ...
    : [];
  const selectedActionNoteCards = selectedActionNotes.slice(0, 3).map((note, index) => {
    const splitIndex = note.indexOf(":");
    const title = splitIndex > 0 ? note.slice(0, splitIndex).trim() : ["Target watchlist", "Upside hold", "Roster churn"][index] || "AI note";
                      ...
                      body={
                        <div className="ai-notes-feature-shell">
                          ...
                          >
                            ...
                            />
                            <circle className="ai-notes-feature-node ai-notes-feature-node-cyan" cx="17" cy="13.25" r="0.7" />
                            <circle className="ai-notes-feature-node ai-notes-feature-node-cyan" cx="33" cy="10.5" r="0.65" />
                            <circle className="ai-notes-feature-node ai-notes-feature-node-cyan" cx="53" cy="13.25" r="0.72" />
                            <circle className="ai-notes-feature-node ai-notes-feature-node-cyan" cx="72" cy="17.5" r="0.65" />
                            <circle className="ai-notes-feature-node ai-notes-feature-node-amber" cx="39" cy="15.5" r="0.62" />
                            <circle className="ai-notes-feature-node ai-notes-feature-node-amber" cx="65" cy="18.25" r="0.68" />
                            <circle className="ai-notes-feature-node ai-notes-feature-node-amber" cx="83" cy="5.75" r="0.6" />
                          </svg>

                          <div className="ai-notes-module-grid">
                            {selectedActionNoteCards.map(card => {
                              ...
                              return (
                                ...
                                >
                                  <span className="ai-notes-module-icon" aria-hidden="true">
                                    <NoteIcon />
                                  </span>
                                  <p>
...
function getTradeProposalStatusTone(
  status?: string | null
