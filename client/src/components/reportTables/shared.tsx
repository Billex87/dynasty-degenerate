...
export type TradePickFlipOutcome = {
  date: string | null;
  fromRosterId: number | null;
  toRosterId: number | null;
  assets: string[];
};
export type ParsedTradePickItem = {
  label: string;
  displayLabel: string;
  value: number | null;
  ...
  flipOutcome: TradePickFlipOutcome | null;
  round: number | null;
  pickNumber: string | null;
};
export type ParsedTradePlayerItem = {
  playerId: string;
  playerName: string;
  value: number | null;
...
export function formatPickRound(round: number): string {
...
export function parseTradePickItem(
  trimmed: string
): ParsedTradePickItem | null {
...
export function findLandedPick(
  parsedPick: ParsedTradePickItem | null,
...
export function parseTradePlayerItem(
  trimmed: string
): ParsedTradePlayerItem | null {
...
export function parseValueAdjustmentItem(trimmed: string): number | null {
