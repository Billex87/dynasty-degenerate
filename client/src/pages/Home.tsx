      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 flex flex-col">
        ...
        <div className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8 w-full">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className="flex flex-wrap justify-center gap-2 md:gap-4 lg:gap-6 bg-transparent border-0 p-0 mb-10 sm:mb-6 md:mb-4 lg:mb-3 relative z-10 w-full" style={{ maxWidth: '600px', margin: '0 auto' }}>
