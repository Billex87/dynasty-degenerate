          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <TabsContent value="momentum" className="mt-0 pt-16 sm:pt-12 md:pt-8 lg:pt-4">
              <div className="space-y-8">
                <div>
                  <h3 className="text-xl font-bold mb-4 text-emerald-400">Top 15 Weekly Risers</h3>
                  <SearchableWeeklyMomentumTable data={reportData.weeklyRisers} title="Weekly Risers" />
                </div>
                <div>
                  <h3 className="text-xl font-bold mb-4 text-red-400">Top 15 Weekly Fallers</h3>
              ...
              <div className="space-y-8">
                <div>
                  <div className="space-y-2 mb-4">
                    <h3 className="text-xl font-bold text-emerald-400">Top 25 Risers</h3>
                    <p className="text-sm text-slate-400">Players about to make your league mates look stupid next year.</p>
                  </div>
                  <SearchableProjectedMoversTable data={reportData.projectedRisers} title="Projected Risers" />
                </div>
                <div>
                  <div className="space-y-2 mb-4">
                    <h3 className="text-xl font-bold text-red-400">Top 25 Fallers</h3>
                    <p className="text-sm text-slate-400">Players about to tank your roster value.</p>
                  </div>
            ...
            <TabsContent value="trades" className="mt-0 pt-16 sm:pt-12 md:pt-8 lg:pt-4">
              <div className="space-y-8">
                <div>
                  <h3 className="text-xl font-bold mb-4">All-Time Trade Profit Leaderboard</h3>
                  <TradeProfitLeaderboardTable data={reportData.tradeProfitLeaderboard} />
                </div>
                <div>
                  <h3 className="text-xl font-bold mb-4">Full Trade Ledger</h3>
      ...
      <div className="border-t border-orange-500/20 bg-gradient-to-r from-slate-900/80 to-slate-950/80 backdrop-blur mt-8 sm:mt-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
          ...
          <div className="border-t border-slate-700 py-2 text-center">
            <div className="flex justify-center h-20 sm:h-24">
              <img 
            ...
            <p className="bg-gradient-to-r from-orange-500 to-orange-400 bg-clip-text text-transparent font-bold text-xs sm:text-sm -mt-2">
